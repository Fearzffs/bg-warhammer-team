...
export default function Home() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
      {/* Hero Section with SVG and Social Links */}
      <div className="grid lg:grid-cols-2 gap-0 lg:gap-8">
        {/* Left side - SVG (Full Height) */}
        <div className="flex justify-center lg:justify-start items-center">
          <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg  sm:h-80 lg:h-auto">
            <Image
              src="/images/lion.svg"
              alt="Bulgarian Warhammer Team Lion"
              width={400}
              height={500}
        ...
        <div className="flex flex-col text-center lg:text-left h-full">
          <div className="flex-1 flex flex-col justify-center">
            <h1 className="text-4xl lg:text-5xl font-bold text-white mb-4 pt-8">
          ...
          <div className="flex flex-wrap justify-center lg:justify-start gap-3 max-w-2xl mx-auto lg:mx-0 mb-8 mt-8 lg:mt-0 lg:mb-16">
            <a
              href="https://discord.gg/wbwYc2b3KG"
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-center p-6 bg-zinc-900 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors group min-w-[90px]"
            >
              <svg className="w-8 h-8 text-[#5865F2] mb-2" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-sm font-semibold text-white group-hover:text-[#5865F2] transition-colors">
                Discord
              </span>
            </a>
            ...
            <a
              ...
              className="flex flex-col items-center p-6 bg-zinc-900 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors group min-w-[90px]"
            >
              <svg className="w-8 h-8 text-[#FF0000] mb-2" fill="currentColor" viewBox="0 0 24 24">
                <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
              </svg>
              <span className="text-sm font-semibold text-white group-hover:text-[#FF0000] transition-colors">
                YouTube
              </span>
            </a>
            ...
            <a
              ...
              className="flex flex-col items-center p-6 bg-zinc-900 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors group min-w-[90px]"
            >
              <svg className="w-8 h-8 text-[#E4405F] mb-2" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-sm font-semibold text-white group-hover:text-[#E4405F] transition-colors">
                Instagram
              </span>
            </a>
            ...
            <a
              ...
              className="flex flex-col items-center p-6 bg-zinc-900 rounded-lg border border-zinc-800 hover:border-zinc-700 transition-colors group min-w-[90px]"
            >
              <svg className="w-8 h-8 text-[#1877F2] mb-2" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
              </svg>
              <span className="text-sm font-semibold text-white group-hover:text-[#1877F2] transition-colors">
                Facebook
              </span>
            </a>
            ...
            >
              ...
              <span className="text-sm font-semibold text-white group-hover:text-emerald-500 transition-colors">
                Players
              </span>
            </Link>
          </div>
